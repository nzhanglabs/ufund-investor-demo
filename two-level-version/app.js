const roles = {
  qualified: { label: "Qualified Access", level: 2 },
...
const pages = {
  "start-here": {
    ...
    navLabel: "Start Here",
    sections: [
      { h: "Qualified Access", p: "Resource Center + Qualified Library access: newsletters, videos, reports, events, track record summary, GFD and join process." },
      { h: "Club Member", p: "Includes all Qualified Access documents, plus Active Deals full package rooms, Pipeline Watchlist, and Priority Q&A." }
    ]
  },
  "resource-center": {
  ...
  "member-vault": {
    ...
    subtitle: "Includes all Qualified Access documents plus member-only channels and full package data rooms.",
    minLevel: 3,
    ...
    cards: [
      {
        ...
        desc: "Upgrade to Club Member to keep all Qualified Access docs and unlock Deal Data Rooms (Full Package) + member-only channels.",
    ...
    cards: [
      {
        ...
        desc: "You can access all Qualified Access documents, plus priority updates, deal package rooms, and member Q&A.",
...
const fixedNav = [
  ...
  { label: "Qualified Access", route: "qualified-library", minLevel: 2 },
...
function renderHeader(route, role) {
  ...
  if (role === "member") {
    ui.roleHint.textContent = "Club Member includes all Qualified Access documents and adds Active Deals + Pipeline Watchlist.";
  } else {
    ui.roleHint.textContent = "Qualified Access: Resource Center + Qualified Library are open. Active Deals and Pipeline Watchlist remain locked.";
  }
}
